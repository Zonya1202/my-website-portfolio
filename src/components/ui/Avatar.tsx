...
/*
  Аватарка в круге + иконки скилов по орбите. Всё в относительных единицах
  (% от контейнера) — масштабируется без горизонтального скролла.
*/
const ORBIT_PERCENT = 42 // радиус орбиты, % от размера контейнера
const ORBIT_SECONDS = 40 // секунд на один оборот
      ...
      >
        {skills.map(({ icon: Icon, label, color }, i) => {
          ...
          return (
            ...
            >
              {/* Контр-вращение, чтобы иконка не переворачивалась вместе с орбитой */}
              <motion.div
                title={label}
